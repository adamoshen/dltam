...
The DLTAM scores can be obtained by passing `daily_temperature_wide` to `dltam::dltam()`. We set the
window size to 5 and the Moving Approximation Transform sequence size to 3.
